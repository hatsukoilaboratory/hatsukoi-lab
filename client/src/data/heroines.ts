...
export const heroines: Heroine[] = [
  ...
  { id: 5, slug: "haishinsha", name: "地味っ子配信者ちゃん", quote: "「ほんとのわたし、知っても……離れないでね」", color: "#B9A5D4", motif: "haishinsha", tags: ["VTuber", "クラスメイト", "ひみつ"], generation: 2025, height: 150, cup: "D", chibiImage: "/assets/haishinsha_97c8bdd3.webp", standingImage: "/assets/haishinsha_0b310757.webp", bustImage: "/assets/haishinsha_e56ecc07.webp", listImage: "/assets/haishinsha_7b03b1ce.webp", bustPosition: "50% 26%" },
  { id: 6, slug: "ai", name: "アイちゃん", quote: "「あなたにアイを伝えにきたよ♪」", color: "#8CB7D0", motif: "ai", tags: ["アンドロイド", "同居", "近未来"], generation: 2025, height: 161, cup: "E", chibiImage: "/assets/ai_611005db.webp", standingImage: "/assets/ai_b304d2a8.webp", bustImage: "/assets/ai_c82d8395.webp", listImage: "/assets/ai_3b85817c.webp", bustPosition: "50% 29%" },
